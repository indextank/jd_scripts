...
const inviteCodes = [
  `T0205KkcIkxckBO_WGiKyo1oCjVfnoaW5kRrbA@T024uvh2SRkQ9VHXPRvwlv8NcNb9CjVfnoaW5kRrbA@T0225KkcR08R8QCCIhrxkPRfJgCjVfnoaW5kRrbA`,
  `T0205KkcAkVQqSKGVWOv0oV2CjVfnoaW5kRrbA@T0084qAiHhYeCjVfnoaW5kRrbA`
]
...
function readShareCode() {
  ...
  return new Promise(async resolve => {
    $.get({
      url: `https://raw.githubusercontent.com/indextank/jd_scripts/main/shareCodes/jd_health.json`,
      'timeout': 60000
    }, (err, resp, data) => {
      try {
        if (err) {
