...
let shareCodes = [ // IOS本地脚本用户这个列表填入你要助力的好友的shareCode
  ...
  '7qol36k2wexalexopbwitsnlk7dlfaq6w3g7ooa@tcu2fa5tmlgnp7kr6656lap2soxi6oepe573m4a@bmiqsfq6pjgaux6emvmykdxamy@4vvbjlml6tdfdmupxpjymceethvrrhccs3kd2ui@4npkonnsy7xi2z3dkz5zl7dytucijlyfpo3mliq@cshk5bfjifz75j3sxlqcin52ywcqgxgmvmx65by'
...
function readShareCode() {
  return new Promise(async resolve => {
    $.get({ url: `https://share.turinglabs.net/api/v3/bean/query/${randomCount}/`, timeout: 10000 }, (err, resp, data) => {
      try {
        if (err) {
