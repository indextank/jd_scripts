...
47 3 * 9 * node /scripts/myActions/gua_opencard24.js >>/scripts/logs/gua_opencard24.log 2>&1        # 1min ~ 9月
40 3 12-21 9 * node /scripts/myActions/gua_opencard29.js >>/scripts/logs/gua_opencard29.log 2>&1    # 5min 9月12号 ~ 9月21号
