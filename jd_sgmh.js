...
function readShareCode() {
  ...
  return new Promise(async resolve => {
    $.get({
      url: "https://raw.githubusercontent.com/indextank/myjd3/master/shareCodes/jd_sgmh.json", headers: {
      ...
      try {
        if (err) {
          ...
          $.get({ url: `https://raw.githubusercontent.com/indextank/myjd3/master/shareCodes/jd_sgmh.json`, 'timeout': 10000 }, (err, resp, data) => {
            data = JSON.parse(data);
          })
        } else {
          if (data) {
