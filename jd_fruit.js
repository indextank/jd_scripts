...
let shareCodes = [
  "1e4d7e29cf584727a483b509a35b4735@7035c5fc71424e74bc58e5f39b1505b2@5633948454934afba0f459ae374de5a4@5252199465ce4cbc8d1b8637fb1d5df1@447c49d888ee4f339314b55b79de0c74@412aa69dda9b4c41967a25060c6d794a"
]
...
function readShareCode() {
  return new Promise(async resolve => {
    $.get({
      url: "https://raw.githubusercontent.com/indextank/jd_scripts/master/shareCodes/jd_fruit.json", headers: {
      ...
      try {
        if (err) {
          ...
          $.get({ url: `https://raw.githubusercontent.com/indextank/jd_scripts/master/shareCodes/jd_fruit.json`, 'timeout': 10000 }, (err, resp, data) => {
