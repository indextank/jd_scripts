...
const injectToRequest = require("./utils/jd_joy_validate").injectToRequest, USER_AGENT = require("./utils/USER_AGENTS").USER_AGENT, md5 = require('md5')
...
!(async () => {
  ...
  for (let i = 0; i < cookiesArr.length; i++) {
    if (cookiesArr[i]) {
      ...
      $.isLogin = true;
      $.nickName = $.UserName;
      if (!require('./utils/JS_USER_AGENTS').HelloWorld) {
