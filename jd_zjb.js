  ...
  for (let i = 0; i < cookiesArr.length; i++) {
    if (cookiesArr[i]) {
      ...
      if (InviterPin.length != 0) {
        ...
        await help2("jd_RbuUwXHBNnJR", "ob5uluTqqxkim0Mz5lIK1w==")
        await help2("455979050", "F7o+2zi5L+gQIWuMgmnTBRosMAxTWqRP8DMXr9e39pM=%3D%3D")
        await help2("jd_fMRfXcJHjROT", "i7My3ErIYoVy2fjiHNhoeg==")
        await help2("jd_7a84de20543eb", "N5sXHbGLgXflqADjaEVA5gmTtt2WMvSoxj2dlWMjlTs=")
        await help2("lman87", "OQ+S7/wCR4DRCtWr99wWGw==")
        await help2("jd_rkylFaEIkvBL", "BOOWzXEQuXFwLXyL4O4Yhg==")
      }
    }
  }
})()
