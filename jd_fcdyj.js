...
function getAuthorShareCode() {
    return new Promise(resolve => {
        $.get({
            url: "https://raw.githubusercontent.com/indextank/jd_scripts/main/shareCodes/dyj.json",
            headers: {
