...
!(async () => {
  ...
  for (let i = 0; i < newCookiesArr.length; i++) {
    ...
    // 2021-06-16 手动添加 - huige
    let codeList = [
      "QZRR6XCI0kJS49w-ATy8PBaBh1CILOGuyGFtFfTrDfTdm9Dwrfyv5CDjyfrxzE9j",
      "QZRR6XCI0kJS49w-ATy8PIUA3uGSWbHXZ8J-jxT36IU",
      "QZRR6XCI0kJS49w-ATy8PO11RLoT3Qrvq1aB5ehr29oxbFOxHcsOdtPbnltVGFXe",
      "QZRR6XCI0kJS49w-ATy8PMBR8c2MRVvwAOPHY_tNVnZxs2bnqcRl-wXX2EfVMbb0",
      "QZRR6XCI0kJS49w-ATy8PCNgV-lGXzFKiZ15lG_-zq6-niXdpKCpY9rCW3JhuDMT"
    ];
